                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-row">
                                                        ...
                                                        <input  type="text" name="id" class="input namefild" required > 
                                                    </div>
                                                    <div class="form-row">
                                                        <label class="lebel-abs">
                                                            Name
                                                        ...
                                                        <input  type="text" name="sname" class="input namefild" required > 
                                                    </div>
                                                    <div class="form-row">
                                                        <label class="lebel-abs">
                                                            Quantity
                                                        ...
                                                        <input type="text" name="quantity" class="input namefild" required>
                                                    </div>
                                                    <div class="form-row">
                                                        <label class="lebel-abs">
                                                            Price 
                                                        ...
                                                        <input type="text" name="price" class="input namefild" required>
                                                    </div>
                                                     <h4><%=mess%></h4>
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-row">
                                                        ...
                                                        <input type="text" name="picture" class="input namefild">
                                                    </div>
                                                    <div class="form-row">
                                                        <label class="lebel-abs">
                                                            Description 
                                                        ...
                                                        <input type="text" name="description" class="input namefild">
                                                    </div>
