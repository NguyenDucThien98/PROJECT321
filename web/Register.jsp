...
<html>
    ...
    <body>
        <%
            String username = "Login";// (String) request.getAttribute("username");
                                ...
                                <ol class="checkout-steps">
                                    <li class="steps active">
                                        ...
                                        <div class="step-description">
                                            <form  method="post" action="Register?service=Register">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="your-details">
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <input type="text" class="input namefild" name="Name"  required>
                                                            </div>
                                                            <div class="form-row">
                                                                <label class="lebel-abs">
                                                                    Telephone 
                                                                ...
                                                                <input type="text" class="input namefild" name="Telephone" required>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="your-details">
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <input type="text" class="input namefild" name="UserName" minlength="6" required>
                                                            </div>
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <input type="password" class="input namefild" name="Password" minlength="6" required>
                                                            </div>
                                                            <div class="form-row">
                                                                <label class="lebel-abs">
                                                                ...
                                                                <input type="password" class="input cpass" name="Password2" required>
                                                            </div>
